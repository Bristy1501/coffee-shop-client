...
console.log(` https://coffee-store-server-99fwrlmdg-tamanna-zaman-bristys-projects.vercel.app/users/${id}`)
                fetch(` https://coffee-store-server-99fwrlmdg-tamanna-zaman-bristys-projects.vercel.app/users/${id}`, {
                    method: 'DELETE'
                })
                    .then(res =>res.json())
                    .then(data=>{
